...
public class SmaregiTransactionItemReader extends AbstractSmaregiItemReader {
    ...
    protected URI getApiUrl(int page) {
        ...
        try {
            ...
            // クエリパラメータを組み立てる
            String urlString = String.format("%s?transaction_date_time-from=%s&transaction_date_time-to=%s&page=%d&limit=100&with_details=all&sort=transaction_datetime:asc",
