...
public class StaffRawDataProcessor implements ItemProcessor<Map<String, Object>, StaffRawData> {

    private final ObjectMapper objectMapper;
    private final AppVendorProperties vendorProperties;

    @Override
    public StaffRawData process(Map<String, Object> item) throws Exception {
        // 1. Map -> JSON文字列
        ...
        return new StaffRawData(companyId, json);
    }
}
